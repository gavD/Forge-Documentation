# -*- coding: utf-8 -*-
#
# Cross-browser Add-on Development documentation build configuration file, created by
# sphinx-quickstart on Tue Jan 25 00:01:57 2011.
#
...
# the title page.
latex_logo = '_static/images/trigger-forge.png'
...
man_pages = [
    ('index', 'cross-browseradd-ondevelopment', u'Cross-browser Add-on Development Documentation',
     [u'James Brady'], 1)
]
